...
<div class="wrap">
  ...
  <section class="card" id="factCard">
    ...
    <div class="grid" style="margin-top:16px">
      ...
      <div class="field"><label>상품코드</label><input id="productCode" placeholder="저장하면 자동 생성됩니다" readonly><div class="muted">PRD-000001 형식으로 자동 발급됩니다.</div></div>
      <div class="field full"><label>판매 옵션</label><input id="options" placeholder="예: 10m, 20m, 30m · 옵션이 없으면 비워두세요"><div class="muted">비워두면 기본 SKU 1개가 자동 생성됩니다.</div></div>
