...
HTML = r'''<!doctype html><html lang="ko"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>상품 콘텐츠 현황 · AI Business OS</title>
<style>
...
<div class="top"><div><h1>상품 콘텐츠 현황</h1><div class="muted">상품별 FACT·원본·이미지·상세페이지 준비 상태를 확인합니다.</div></div><div><a class="btn secondary" href="/dashboard">← 대시보드</a> <a class="btn secondary" href="/commerce-catalog">상품관리 센터</a> <a class="btn primary" href="/product-registration">＋ 신규 상품 등록</a></div></div>
...
def inject_product_overview_link(html: str) -> str:
    ...
    addition = marker + '\n      <a href="/commerce-catalog">상품관리 센터</a>\n      <a href="/products">상품 콘텐츠 현황</a>'
    if marker in html:
